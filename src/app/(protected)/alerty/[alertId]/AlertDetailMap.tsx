...
import type { MapAlert, MapDisplayMode } from '../../map/AlertMap';
import type { AlertKindValue } from '@/lib/alertLabels';

// Same client-only import AlertsMapView.tsx uses (see src/lib/dynamicClientOnly.tsx)
// — Leaflet touches `window` at module load time and breaks server-side
// rendering otherwise.
const AlertMap = dynamicClientOnly(() => import('../../map/AlertMap'), {
  loading: () => (
