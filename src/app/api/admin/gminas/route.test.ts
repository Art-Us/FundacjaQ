...
describe('GET /api/admin/gminas', () => {
  ...
  // access at all (requireGlobalAdmin() itself returns null for them, same
  // as it does for a non-admin).
  it('rejects a gmina-scoped admin with 403 and no DB call', async () => {
    vi.mocked(requireGlobalAdmin).mockResolvedValue(null);
