...
// Auto-mocked: every export becomes a vi.fn() returning undefined, i.e. a
// no-op invalidate, so these tests are unaffected by this cache's existence
// — without this, invalidateAlertAccessCache() would hit the real Redis client.
